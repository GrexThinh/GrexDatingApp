...
namespace API.Data.Migrations
{
    ...
    [Migration("20250412121025_updateGroupEvent4")]
    partial class updateGroupEvent4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.FanGroupType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("FanGroupTypes");
                });

            modelBuilder.Entity("API.Entities.FanGroupUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Entities.GroupEventComment", b =>
                {
                    ...
                    b.ToTable("GroupEventComments");
                });

            modelBuilder.Entity("API.Entities.GroupEventUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Entities.GroupEventComment", b =>
                {
                    b.HasOne("API.Entities.GroupEventComment", "ParentComment")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Entities.Photo", b =>
                {
                    ...
                    b.HasOne("API.Entities.GroupEvent", null)
                        .WithMany("Photos")
                        .HasForeignKey("GroupEventId");
